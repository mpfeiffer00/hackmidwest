...
public class UsersApi
{
    ...
    @io.swagger.annotations.ApiResponses(
            value = {@io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Void.class)})
    public Response createItemForUser(@ApiParam(value = "The id that needs to be fetched.", required = true) @PathParam("userId") String userId,
            @ApiParam(value = "Created item object", required = true) Item body, @Context SecurityContext securityContext) throws NotFoundException
    {
    ...
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Get an item for the user.", notes = "Retrieve an item belonging to the user.",
            response = Item.class, tags = {})
    @io.swagger.annotations.ApiResponses(
            value = {@io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Item.class),
    ...
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Get all items for the user.", notes = "Retrieve a list of all items belonging to the user.",
            response = Item.class, responseContainer = "List", tags = {})
    ...
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Get user by user id", notes = "Retrieve the User by the user's id", response = User.class,
            tags = {})
    @io.swagger.annotations.ApiResponses(
            value = {@io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = User.class),
