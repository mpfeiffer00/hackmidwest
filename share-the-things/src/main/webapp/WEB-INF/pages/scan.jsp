...
<body>
	<div class="main">
		...
		<div id="mainContent" class="content">
			...
			<div>
				<form id="upload-form" class="upload-box" action="upload"
					method="post" enctype="multipart/form-data">
					<input type="file" id="file" name="file1" /> <span
						id="upload-error" class="error">${uploadError}</span> <input
						type="button" id="upload-button" value="upload" onclick="" />
				</form>
			</div>
		</div>
	</div>
